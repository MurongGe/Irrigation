...
#define IIC_SCL_GPIO_PORT               PCF_I2C_SCL_GPIO_Port
#define IIC_SCL_GPIO_PIN                PCF_I2C_SCL_Pin
#define IIC_SCL_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define IIC_SDA_GPIO_PORT               PCF_I2C_SDA_GPIO_Port
#define IIC_SDA_GPIO_PIN                PCF_I2C_SDA_Pin
