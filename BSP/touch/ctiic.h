...
#define CT_IIC_SCL_GPIO_PORT            GTX_I2C_SCL_GPIO_Port
#define CT_IIC_SCL_GPIO_PIN             GTX_I2C_SCL_Pin
#define CT_IIC_SCL_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define CT_IIC_SDA_GPIO_PORT            GTX_I2C_SDA_GPIO_Port
#define CT_IIC_SDA_GPIO_PIN             GTX_I2C_SDA_Pin
...
#define CT_READ_SDA       HAL_GPIO_ReadPin(GTX_I2C_SDA_GPIO_Port, GTX_I2C_SDA_Pin) /* 读取SDA */
