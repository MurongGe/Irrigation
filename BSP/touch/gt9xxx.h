...
#define GT9XXX_RST_GPIO_PORT            GTX_RST_GPIO_Port
#define GT9XXX_RST_GPIO_PIN             GTX_RST_Pin
#define GT9XXX_RST_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)   /* PC口时钟使能 */

#define GT9XXX_INT_GPIO_PORT            GTX_INT_GPIO_Port
#define GT9XXX_INT_GPIO_PIN             GTX_INT_Pin
